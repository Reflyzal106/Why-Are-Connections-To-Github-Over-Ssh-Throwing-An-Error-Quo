# [SOLVED] Why-Are-Connections-To-Github-Over-Ssh-Throwing-An-Error-Quo
...
>
> ### ➡️ [CLICK HERE TO VIEW THE FULL FIX GUIDE](https://techfixdocs.my.id/why-are-connections-to-github-over-ssh-throwing-an-error-quo)
>
...
This warning is normal and indicates that the SSH host key has changed on GitHub's servers. To resolve, run "ssh-keygen -f ~/.ssh/known_hosts -R github.com" to update your known hosts file.
...
👉 **[Go to ErrorFix Hub Full Article](https://techfixdocs.my.id/why-are-connections-to-github-over-ssh-throwing-an-error-quo)**
